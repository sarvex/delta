...
pub struct Config {
    ...
    pub grep_hunk_header_file_style: Style,
    pub grep_hunk_header_style: Style,
...
impl From<cli::Opt> for Config {
    fn from(opt: cli::Opt) -> Self {
        ...
        Self {
            ...
            grep_hunk_header_file_style: styles["grep-hunk-header-file-style"],
            grep_hunk_header_style: styles["grep-hunk-header-style"],
